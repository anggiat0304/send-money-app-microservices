...
public class SpringKafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        configMap.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.orderservice.model");
    ...
    public ConsumerFactory<String, Order> consumerFactory() {
        ...
        configMap.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.orderservice.mode");
